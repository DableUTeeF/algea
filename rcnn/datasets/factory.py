...
__sets = {}
from rcnn.datasets.pascal_voc import pascal_voc
from rcnn.datasets.coco import coco
from rcnn.datasets.imagenet import imagenet
from rcnn.datasets.vg import vg
