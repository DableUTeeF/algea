...
class opts(object):
    ...
    def parse(self, args=''):
        ...
        opt.data_dir = os.path.join(opt.root_dir, 'data')  # todo: do something about dataset here
        opt.exp_dir = os.path.join(opt.root_dir, 'exp', opt.task)
        opt.save_dir = os.path.join('/home/palm/PycharmProjects/algea/snapshots/centernet', opt.exp_id)
